...
//Refactoring five cards from card effect
int case_adventurer(struct gameState *state){
	int currentPlayer = whoseTurn(state);
...
int case_baron(struct gameState *state, int choice1){
    ...
    if (choice1 > 0){//Boolean true or going to discard an estate
		...
		int card_not_discarded = 2;//Flag for discard set!
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case remodel:
    	return case_remodel(state, choice1, choice2, handPos);
    ...
    case baron:
    	return case_baron(state, choice1);

    case great_hall:
    	return case_great_hall(state, handPos);
    ...
    case ambassador:
    	return case_ambassador(state, choice1, choice2, handPos);
