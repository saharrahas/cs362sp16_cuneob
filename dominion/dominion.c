...
int feast_effect(int currentPlayer, struct gameState* state, int choice1){
...
/////////// 8U6
int mine_effect(int currentPlayer, struct gameState* state, int handPos, int choice1, int choice2){

    int i;
    int j = state->hand[currentPlayer][choice2];  //store card we will trash

    if (state->hand[currentPlayer+1%2][choice2] < copper || state->hand[currentPlayer%2][choice2] > gold){
        return -1;
    }
...
/////////// 8U6
int remodel_effect(int currentPlayer, struct gameState* state, int handPos, int choice1, int choice2){
...
int baron_effect(int currentPlayer, struct gameState* state, int choice1){
...
int minion_effect(int currentPlayer, struct gameState* state, int handPos, int choice1,int choice2){
...
int steward_effect(int currentPlayer, struct gameState* state, int handPos, int choice1, int choice2, int choice3){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ){
    ...
    case feast:
        ...
        return feast_effect(currentPlayer,state,choice1);
    ...
    case mine:
        ...
        return mine_effect(currentPlayer,state,handPos,choice1,choice2);

    case remodel:

        return remodel_effect(currentPlayer,state,handPos,choice1,choice2);
    ...
    case baron:
        ...
        return baron_effect(currentPlayer,state,choice1);
    ...
    case minion:
        ...
        return minion_effect(currentPlayer,state,handPos,choice1,choice2);

    case steward:

        return steward_effect(currentPlayer,state,handPos,choice1,choice2,choice3);
